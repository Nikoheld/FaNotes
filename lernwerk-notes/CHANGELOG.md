...
- die einmalige Suche nach früheren FaNotes-/Lernwerk-Profilen läuft parallel zur Electron-Initialisierung und wird nach erfolgreichem Abschluss dauerhaft übersprungen
...
- isolierter Reset-Test verhindert, dass alte Lernwerk-Profile nach einem bewussten Reset ungewollt wieder importiert werden
...
- Originaldateien und validierte Textfeld-Metadaten sicher und atomar unter `.lernwerk/worksheets` im Vault speichern
...
- vollständiges Rebranding von Lernwerk Notes zu FaNotes
...
- vorhandene Vaults und der interne `.lernwerk`-Kompatibilitätsordner bleiben ohne Datenumzug weiter nutzbar
