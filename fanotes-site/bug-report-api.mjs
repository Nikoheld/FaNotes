...
const sanitizeEvent = (raw) => {
  ...
  return {
    ...
    pageW: finiteLayout(raw.pageW),
    pageH: finiteLayout(raw.pageH),
    padX: finiteLayout(raw.padX),
    padY: finiteLayout(raw.padY),
    camX: finiteLayout(raw.camX),
