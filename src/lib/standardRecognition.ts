...
const manualHandwritingPaths: Record<string, StandardPath[]> = {
  ...
  i: [
    [[0, .66], [.22, .61], [.38, .38], [.48, .76], [.56, .4], [.72, .61], [1, .66]],
    [[.5, .17]],
  ],
  j: [
    [[0, .6], [.22, .54], [.44, .38], [.48, .92], [.38, 1.0], [.2, .9], [1, .66]],
    [[.5, .17]],
  ],
  z: [[[0, .38], [.72, .38], [.18, .78], [.82, .78], [1, .66]]],
}
...
const manualUppercaseHandwritingPaths: Record<string, StandardPath[]> = {
  ...
  O: [ellipsePath(0.5, 0.51, 0.29, 0.36)],
  S: [[[0.76, 0.22], [0.54, 0.14], [0.3, 0.2], [0.24, 0.38], [0.7, 0.58], [0.76, 0.73], [0.56, 0.86], [0.28, 0.78]]],
  X: [
    [[0.24, 0.18], [0.76, 0.86]],
    [[0.76, 0.18], [0.24, 0.86]],
  ],
  Y: [
    [[0.22, 0.18], [0.5, 0.5], [0.78, 0.18]],
    [[0.5, 0.5], [0.5, 0.86]],
  ],
  Z: [[[0.22, 0.18], [0.78, 0.18], [0.22, 0.86], [0.78, 0.86]]],
  L: [[[0.3, 0.18], [0.3, 0.86], [0.78, 0.86]]],
  U: [[[0.26, 0.18], [0.26, 0.68], [0.36, 0.84], [0.64, 0.84], [0.74, 0.68], [0.74, 0.18]]],
  V: [[[0.2, 0.18], [0.5, 0.86], [0.8, 0.18]]],
  W: [[[0.14, 0.18], [0.31, 0.86], [0.5, 0.42], [0.69, 0.86], [0.86, 0.18]]],
}
