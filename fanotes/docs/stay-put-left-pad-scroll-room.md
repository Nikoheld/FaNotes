...
Gating check: `npm run check:stay-put` also drives report `1788433450822` (pad 0, pan 560/560 → 435/1745 → 2586, height 1408→2880). Max-edge canvas extend must hold the paper camera (`paperCameraAfterMaxEdgeGrow`).
