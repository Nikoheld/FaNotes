...
Gating check: `npm run check:stay-put` (`scripts/check-stay-put.mjs`) also drives report `1788416428895` (pads 108/144 already applied, then cam 668/640 → 632/1978 with height 1552→2448). Grow/selection measure must not pan the paper camera to the caret.
