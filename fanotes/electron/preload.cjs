...
const CHANNELS = Object.freeze({
  ...
  syncVaultId: 'fanotes:sync-vault-id',
  syncScan: 'fanotes:sync-scan',
  syncRead: 'fanotes:sync-read',
  syncWrite: 'fanotes:sync-write',
  syncRemove: 'fanotes:sync-remove',
  syncReadState: 'fanotes:sync-read-state',
  syncWriteState: 'fanotes:sync-write-state',
  syncReadSecrets: 'fanotes:sync-read-secrets',
  syncWriteSecrets: 'fanotes:sync-write-secrets',
...
const api = Object.freeze({
  ...
  sync: {
    vaultId: () => invoke(CHANNELS.syncVaultId),
    scan: () => invoke(CHANNELS.syncScan),
    read: (relativePath) => invoke(CHANNELS.syncRead, relativePath),
    write: (relativePath, bytes, mtimeMs) => invoke(CHANNELS.syncWrite, relativePath, bytes, mtimeMs),
    remove: (relativePath) => invoke(CHANNELS.syncRemove, relativePath),
    readState: (vaultId) => invoke(CHANNELS.syncReadState, vaultId),
    writeState: (vaultId, json) => invoke(CHANNELS.syncWriteState, vaultId, json),
    readSecrets: () => invoke(CHANNELS.syncReadSecrets),
    writeSecrets: (json) => invoke(CHANNELS.syncWriteSecrets, json),
  },
