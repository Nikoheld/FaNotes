...
```powershell
Get-FileHash .\FaNotes-Setup-2026.8.9-x64.exe -Algorithm SHA256
Get-FileHash .\FaNotes-Portable-2026.8.9-x64.exe -Algorithm SHA256
```
...
1. `FaNotes-Setup-2026.8.9-x64.exe` herunterladen und öffnen.
